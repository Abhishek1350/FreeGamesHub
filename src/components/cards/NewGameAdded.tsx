...
export const NewGameAdded = () => {
    ...
    return (
        ...
        >
            <CardHeader className="absolute py-8 flex-col z-10 w-full h-full opacity-0 transition-opacity duration-800 hover:opacity-100 bg-black/80">
            ...
            <Image
                ...
                src="https://img.youtube.com/vi/Yj9UeZzp12o/maxresdefault.jpg"
            />
