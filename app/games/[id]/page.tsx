...
import { Container, ModalImageSlider, BlurIn } from "@/components";
...
export default async function Game({ params }: { params: { id: string } }) {
    const game: IGame = await getGameById(params.id);
    ...
    return (
        <section className="text-gray-400 pb-5 shadow-inset-1 min-h-[80dvh]">
            <Container>
                <BlurIn className="flex flex-col">
                    ...
                    <div className="w-full mt-6 px-2 md:px-0">
